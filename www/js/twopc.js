		...
		$(document).off('click', '#two_signout').on('click', '#two_signout', function() {
			...
			$.mobile.changePage("indexpc.html", { transition: "none", changeHash: true, reverse: false });
			return false;
		});
	...
	function changepage(){
				$.mobile.changePage("newmemo.html", { transition: "none", changeHash: true, reverse: false }); 
	}
